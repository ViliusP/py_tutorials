...
Pavyzdžiui elementui `<book id="bk101">...</book>`{ lang=xml } tėvinis elementas yra `<catalog>...</catalog>`{ lang=xml }, `<author>Gambardella, Matthew</author>`, `<title>XML Developer's Guide</title>`, `<genre>Computer</genre>`, `<price>44.95</price>` ir kt. yra tarpusavyje broliniai elementai, o jiems tėvinis yra `<book id="bk101">...</book>`{ lang=xml }.
