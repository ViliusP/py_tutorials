...
## Lentelės patobulinimas

Panaudokime anksčiau aprašytus būdus teksto modifikavimui ir patobulinkime lentelę.

Pridėkime daugiau duomenų:

```python
aaa
```

Pakeiskime ankščiau sudarytos lentelės antraštinės eilės žodžius į žodžius didžiosiomis raidėmis:
...
Atskirkime pirmą eilutę lygybės ženklu:

```python
aaa
```

Atskirkime stulpelius brūkšniais:
