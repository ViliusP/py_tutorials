...
![Koordinačių sistema žaidimo lange](/content_images/coordinate_system_window.png "Koordinačių sistema žaidimo lange"){ height=550 provider=cloudinary }
...
![Descriptive text](/content_images/moving_circle.gif){ height=300 format="gif" provider=cloudinary }
...
![Trys vienspalviai apskritimai](/content_images/same_color_circles.png "Trys vienspalviai apskritimai"){ height=400 format="png" provider=cloudinary}
...
![Trys skirtingų spalvų apskritimai](/content_images/different_color_circles.png "Trys skirtingų spalvų apskritimai"){ height=400 format="png" provider=cloudinary }
...
![Google.com color picker](/content_images/color_picker.png "Google.com „color picker“"){ height=400 format="png" provider=cloudinary}
...
![Youtube: The Continuity of Splines](/content_images/lerp_1.png "Youtube: The Continuity of Splines"){ height=400 format="png" provider=cloudinary }
...
![Youtube: The Continuity of Splines](/content_images/lerp_2.gif "Youtube: The Continuity of Splines"){ height=270 format="gif" provider=cloudinary }
...
![Funkcijos f(x)=sin(x) grafikas](/content_images/sin_plot.png "Funkcijos $$f(x)=\sin(x)$$ grafikas"){ height=400 format="png" provider=cloudinary }
...
![Funkcijos $$f(x)=\frac{1}{2}\sin(x)+\frac{1}{2}$$ grafikas](/content_images/sin_transformed_plot.png "Funkcijos $$f(x)=\frac{1}{2}\sin(x)+\frac{1}{2}$$ grafikas"){ height=400 format="png" provider=cloudinary }
...
![Spalvas bekeičiantis apskritimas](/content_images/animated_color_circle.gif "Spalvas bekeičiantis apskritimas"){ height=357 format="gif" provider=cloudinary }
