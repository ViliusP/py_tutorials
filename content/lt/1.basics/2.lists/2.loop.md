...
Sukurkite du kintamuosius `a`{ lang=python } ir `b`{ lang=python }. Atspausdinkite visus skaičius nuo `a`{ lang=python }(įskaitant) iki `b`{ lang=python }(įskaitant), kurie dalijasi iš 7. Kintamuosius `a`{ lang=python } ir `b`{ lang=python } sukurkite įvedant juos į terminalą.
