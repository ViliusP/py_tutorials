...
Tai atsitinka todėl, kad įvestis yra tipo `string`{ lang=python }, tą galima pamatyti su `type()` funkcija. Tai ankstesniame kode mes sudėjome su eilutės tipo kintamuosius.
