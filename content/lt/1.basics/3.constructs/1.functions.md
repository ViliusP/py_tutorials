...
```python [tic-tac-toe.py] {21-27, 103-110}
...
```python [tic-tac-toe.py] {1-9, 29, 107}
def draw_board():
    print("\nGame Board:")
    print("-"*13)
    for row in board:
...
Jeigu skaičius yra pateiktas slankiojo kablelio (`float`{ lang=python }), jo sveikoji ir trupmeninė dalys yra apdorojamos atskirai, o tada vėl sujungiamas atgal.
