...
```python line-numbers=false
def sort_list(numbers: list[int|float], reverse: bool) -> list[int|float]
```
...
Duomenis galite atsisiųsti [čia](https://googl.e). Čia rasite dvylikos savaičių failus, kurių formatas vienodas. Failo pavyzdys:
